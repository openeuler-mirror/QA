...
release-plan可参考 [24.03 LTS SP4 release-plan](https://gitcode.com/openeuler/release-management/blob/master/openEuler-24.03-LTS-SP4/release-plan.md)
...
4. 测试策略(需求归属-sig):
    * 测试策略制定: 基于社区[测试策略模板](https://gitcode.com/openeuler/QA/blob/master/Test_Delivery_Templates/openEuler%20xx%E7%89%88%E6%9C%ACxx%E7%89%B9%E6%80%A7%E6%B5%8B%E8%AF%95%E7%AD%96%E7%95%A5%E6%A8%A1%E6%9D%BF.md)制定特性测试策略模板，应在社区`Test round 2`转测前提交PR至[QA仓库测试策略目录](https://gitcode.com/openeuler/QA/tree/master/Test_Strategy)。
...
6. 测试结果出口评审(QA-sig):
    * 测试报告编写：基于社区[测试报告模板](https://gitcode.com/openeuler/QA/blob/master/Test_Result/openEuler%20XX版本XX特性测试报告模板.md)进行结果编写，并在社区RC5转测前提交PR至[QA仓库测试报告目录](https://gitcode.com/openeuler/QA/tree/master/Test_Result)
...
## 3. 相关链接
[社区QA仓库](https://gitcode.com/openeuler/QA)
[社区测试策略](https://gitcode.com/openeuler/QA/tree/master/Test_Strategy)
[社区测试报告](https://gitcode.com/openeuler/QA/tree/master/Test_Result)