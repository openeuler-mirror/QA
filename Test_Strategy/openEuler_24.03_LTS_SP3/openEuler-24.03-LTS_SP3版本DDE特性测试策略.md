...
本文是openEuler 24.03 LTS_SP3版本上DDE特性的整体测试策略，用于指导该版本后续测试活动的开展
...
| 3    | [utshell 项目发布]()     |Discussion|sig-memsafety| [@wangmengc](...)| EPOL | utshell                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 4    | [utsudo 项目发布]()      |Discussion|sig-memsafety| [@wangmengc](...) | EPOL | utsudo                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 5    | [增加 utpam 项目发布]()      |Discussion|sig-memsafety| [@wangmengc](...) | EPOL | utpam                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| utpam|  sig-memsafety|  sig-QA | 验证utpam在openEuler版本上可正常编辑PAM配置文件设置认证策略    |
## 功能测试
| 功能描述             | 设计思路      | 测试重点         | 备注 |
|------------------|-----------|--------------| ---- |
...
| utpam          | 多个子应用功能测试 | 测试编辑PAM配置文件设置认证策略  |      |
## 可靠性测试
| 场景描述 | 设计思路 | 测试重点 | 备注 |
| ------- | ------- | ------- | ---- |
|         |         |          |      |
...
|:-------------|:-----------|:-----------|------|--------------------------------------------------| ------ |
| Test round 1 | 2025-11-17 | 2025-11-26 | 4    | DDE、utshell、utsudo、upam全量功能测试<br/>migration-tools功能测试 |      |
| Test round 2 | 2025-12-8 | 2025-12-19 | 2    | 回归测试                                             |      |
