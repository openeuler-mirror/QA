...
|2|[增加可信计算资源分发服务组件](https://gitcode.com/openeuler/release-management/issues/2366)|[详细测试策略文件]()| |√ |　 √ | 　| 　|× |　
|3|[远程证明支持DICE](https://gitcode.com/openeuler/release-management/issues/2434)|[详细测试策略文件]()| | √ |　  | 　| 　|× |　
|4|[海光ccp驱动升级，支持sm4-xts和sm4-gcm](https://gitcode.com/openeuler/release-management/issues/2441)|[详细测试策略文件]()| |× |　 √  | 　| 　|× |　
|5|[新增海光CIS指令集sm3,sm4驱动](https://gitcode.com/openeuler/release-management/issues/2442)|[详细测试策略文件]()| |× |　√ | 　| 　|× |　
|6|[支持树莓派](https://gitcode.com/openeuler/release-management/issues/2448)|[详细测试策略文件]()| | √ |　 × | 　| 　|× |　
