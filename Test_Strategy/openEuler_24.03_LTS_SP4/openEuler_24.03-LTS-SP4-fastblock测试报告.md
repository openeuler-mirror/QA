...
| 指标大项 | 指标小项 | 指标值 | 测试结论 |
| ------- | ------- | ------ | ------- |
| block_bench 性能 | 单副本 4 KiB 随机写 | ~48,000 IOPS | 历史物理机基线，单核 OSD 基本达到磁盘单核写入上限。 |
| block_bench 性能 | 三副本多 PG 4 KiB 随机写 | 441,148 IOPS | 历史物理机基线，三节点/48 OSD 环境下多核并发写入可稳定运行。 |
| vhost 性能 | QEMU 内 fio 多队列随机写 | 372,218 IOPS | vhost-user 对接 QEMU 后可完成虚拟机内 fio 压测，性能相对 block_bench 存在 vhost 层开销。 |
