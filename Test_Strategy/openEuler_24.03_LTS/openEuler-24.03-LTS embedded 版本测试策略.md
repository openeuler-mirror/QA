...
|:----|:---|:---|:--|:----|:----|:----|
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY)  | 【软实时OS】支持边缘控制图形和轻量桌面能力 | Developing | sig-embedded | [@fanglinxu](https://gitee.com/fanglinxu) | 源码 |  |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY)  | 【软实时OS】MICA框架支持 | Developing | sig-embedded | [@fanglinxu](https://gitee.com/fanglinxu) | 源码 |  |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY)  | 【软实时OS】支持嵌入式极简镜像（iSulad） | Developing | sig-embedded | [@fanglinxu](https://gitee.com/fanglinxu) | 源码 |  |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) | 【软实时OS】支持双版本内核  | Developing | sig-embedded | [@fanglinxu](https://gitee.com/fanglinxu) | 源码 |  |
...
| **需求**         | **开发主体** | **测试主体** | **测试分层策略**         |
| --------------- | ----------- | ---------- | ----------------------- |
|[I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) 【软实时OS】支持边缘控制图形和轻量桌面能力 | sig-embedded | sig-embedded | 验证图形化方式正常启动 |
|[I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) 【软实时OS】MICA框架支持 | sig-embedded | sig-embedded | 验证MICA正常启动，命令行交互 |
|[I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) 【软实时OS】支持嵌入式极简镜像（iSulad）| sig-embedded | sig-embedded | 验证镜像构建，isula可用性，使用openEuler发布的docker镜像进行测试 |
|[I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) 【软实时OS】支持双版本内核 | sig-embedded | sig-embedded | 验证不同内核的镜像编译并正常启动 |
...
| ----- | ---------------------- | --------------- | ---------------- | ------ |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) |【软实时OS】支持边缘控制图形和轻量桌面能力 | 测试图形化启动 | 测试图形化镜像构建并正常启动 |  |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) | 【软实时OS】MICA框架支持 | MICA命令行交互 | 测试构建MICA镜像，并可启动相关ClientOS，包括Jailhouse虚拟化层 |  |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) | 【软实时OS】支持嵌入式极简镜像（iSulad） | 测试构建isula极简镜像，拉起后容器可正常使用 | 下载openEuler标准容器镜像，拉起镜像在拉起容器中执行yum等嵌入式没有提供的功能 | |
| [I97DTY](https://gitee.com/openeuler/release-management/issues/I97DTY) |【软实时OS】支持双版本内核 | 镜像编译、基础功能 | 构建不同内核的镜像、测试基础用例 |  |
...
|:----------|:---------|:-------|:---------|:-------|
| Alpha   | 2024/4/9 | 2024/4/15 | 7    | 拉LTS分支, 构建准备 |
| Test round 1           | 2024/4/16  | 2024/4/22  | 7    | 继承特性、性能摸底测试|
| Test round 2           | 2024/4/23 | 2024/4/29 | 7    | 全量SIT验证|
| Test round 3           | 2024/4/30 | 2024/5/6 | 7    | 全量SIT验证试   |
| Test round 4           | 2024/5/7 | 2024/5/13 | 7    | 回归测试   |
| Test round 5           | 2024/5/14 | 2024/5/20 | 7    | 回归测试   |
| Release                | 2024/5/31 | 2024/5/31 | 1    | 社区Release版本发布评审|
