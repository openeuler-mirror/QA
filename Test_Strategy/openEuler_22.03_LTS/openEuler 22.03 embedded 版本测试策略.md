...
对嵌入式操作系统进行性能评估，需要结合特定的硬件和使用场景。我们使用树莓派，一款在社区有广泛使用度的硬件，对软实时特性进行功能验证和性能摸底，并形成性能基线。在待测系统上，使用Hackbench模拟出负载，运行cyclictest大于24小时，统计出平均时延在8微秒。

| **指标大项** | **指标小项**                                                                               | **指标值**              | **说明**                          |
|--------------|--------------------------------------------------------------------------------------------|-------------------------|-----------------------------------|
| 软实时性能   | 中断时延加调度时延 | 平均时延8微秒 | 基于树莓派4B的性能基准 |
