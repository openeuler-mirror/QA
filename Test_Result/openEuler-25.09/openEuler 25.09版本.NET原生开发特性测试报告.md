...
共计执行15个用例，主要覆盖了功能测试和兼容性测试，整体开发代码量2.8k，发现问题4个，代码缺陷密度为1.4/kloc（缺陷密度=问题单个数/代码行数kloc)，发现问题已解决，回归通过，无遗留风险，整体质量良好
...
| 问题链接                                                                    | 问题描述                             | 状态  |
|-------------------------------------------------------------------------|----------------------------------|-----|
| https://gitee.com/src-openeuler/dotnet/issues/ICX73S?from=project-issue | asp.net项目运行报签名类错                 | 已解决 |
...
| https://gitee.com/openeuler/oeDeploy/issues/ICX7CT?from=project-issue   | 虚拟机里curl命令签名验证错误                 | 已解决 |
