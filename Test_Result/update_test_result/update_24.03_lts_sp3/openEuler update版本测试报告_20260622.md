...
| 版本名称 | 测试起始时间 | 测试结束时间 |
| -------- | ------------ | ------------ |
|    openEuler_24.03_LTS_SP3 update_20260622      |    2026-06-23          |     2026-06-24         |
|          |              |              |
...
本周update版本，主要覆盖镜像安装、冒烟测试、包管理测试、单包测试、内核测试、updateinfo测试、docker测试，未发现问题，回归通过，无遗留风险，整体质量良好；

| 测试项目 | 执行用例数量 | 用例通过数量 | 用例失败数量 | 发现问题数量 | 测试项评价 |
| ------- | -------- | ------- |-------- | ------- |-------- |
| 冒烟用例 |    762      |    762      |    0     |    0     |    <font color=green>■</font>     | 
| 单包服务 |    20     |    20     |    0     |    0     |   <font color=green>■</font>     |
| 单包命令 |    145    |  145   |    0     |    0    |    <font color=green>■</font>     |
