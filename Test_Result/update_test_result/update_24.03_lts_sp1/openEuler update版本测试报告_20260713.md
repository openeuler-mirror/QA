...
| 版本名称 | 测试起始时间 | 测试结束时间 |
| -------- | ------------ | ------------ |
|    openEuler_24.03_LTS_SP1 update_20260713      |    2026-07-14          |     2026-07-15         |
|          |              |              |
...
本周update版本，主要覆盖镜像安装、冒烟测试、包管理测试、单包测试、updateinfo测试，未发现问题，回归通过，无遗留风险，整体质量良好；

| 测试项目 | 执行用例数量 | 用例通过数量 | 用例失败数量 | 发现问题数量 | 测试项评价 |
| ------- | -------- | ------- |-------- | ------- |-------- | 
| 冒烟用例 |    664      |    664      |    0     |    0     |    <font color=green>■</font>     |
| 单包服务 |    21       |   21     |    0     |    0     |   <font color=green>■</font>     |
| 单包命令 |    100    |    100  |    0     |    0    |    <font color=green>■</font>     |
