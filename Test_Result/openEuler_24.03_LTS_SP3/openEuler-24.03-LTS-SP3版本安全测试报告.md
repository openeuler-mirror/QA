...
openEuler-24.03-LTS-SP3 版本安全测试已完成 2.2-版本安全测试项目 的所有安全测试。除CVE漏洞问题外，测试发现问题均已完成修复及评估，无遗留问题无风险。
...
测试结果：majun平台漏洞感知详情（数据统计截至2025年12月24日），如下表。待办的漏洞有644个，0分529个，内核115个。内核高分CVE均已修复，115个为低分CVE，SP3版本发布分支冻结，非关键CVE已停止修复，后续在update版本修复。

| 漏洞总数 | 已修复 | 已挂起 | 已拒绝 | 待办的 | 待分析（0分漏洞） |
| -------- | ------ | ------ | ------ | ------ | ----------------- |
| 7122     | 5629   | 97     | 752    | 115    | 529               |
