...
UBS VirtAgent是面向虚拟化场景的核心组件之一，主要功能包括内存碎片场景虚机创建/删除、内存借用/归还，内存超分场景虚机迁移和逃生。
...
| --- | ----------- | :--------: | --- |
| 1 | 内存碎片场景虚机创建/删除 | <font color=green>■</font> |   |
| 2 | Virt Agent内存借用/归还 | <font color=green>■</font> |   |
| 3 | 内存超分场景虚机迁移逃生 | <font color=green>■</font> |   |
