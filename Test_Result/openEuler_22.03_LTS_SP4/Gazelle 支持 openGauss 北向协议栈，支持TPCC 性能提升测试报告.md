...
|     TaiShan200 2280 V2    |   CPU型号：Kunpeng 920 <br />CPU核数：128 <br />网卡：Hi1822           |      |
...
| 指标大项 | 指标小项 | 指标值 | 测试结论 |
| ------- | ------- | ------ | ------- |
|      TPMC   |     单机场景TPCC测试    |    较内核提升15%    |     174.7万,较内核提升30%+，通过    |
|      TPMC   |     一主一备场景TPCC测试    |    较内核提升5%   |     153.8万,较内核提升10%+ ，通过   |
|      TPMC   |     uwal网络一主一备场景TPCC测试    |     较内核提升5%   |     123.9万,较内核提升5%+，通过    |
...
| ------- | ------- | -------- |
|    压力测试    |     主备反复切换    |     通过     |
|    长稳测试    |     100warehourse 200并发 TPCC 7*24测试    |     通过     |
