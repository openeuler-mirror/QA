...
| 日期 | 修订版本 | 修改描述 | 作者 |
| ---- | ------ | ------- | ---- |
| 2026/06/08 | v1.0 | 创建 | @zhanghan2021 |
...
当前的特性交付包括 PilotGo 基础的运维管理能力和四款插件：PilotGo-plugin-a-tune、PilotGo-plugin-grafana、PilotGo-plugin-prometheus、PilotGo-plugin-topology。openEuler 24.03-LTS-SP4 版本整合了这些核心功能和插件，为用户提供了全面的运维管理解决方案。

# 2 特性测试信息

PilotGo 特性在 RISC-V 24.03-LTS-SP4 进行了验证，同时验证 arm 和 x86 版本。

| 版本名称                        | 测试模块           | 测试起始时间 | 测试结束时间 |
|--------------------------------|-------------------|------------|------------|
| openEuler RISC-V 24.03-LTS-SP4 | PilotGo及其四个插件 | 2026/06/02 | 2026/06/08 |
...
PilotGo 在 openEuler-24.03-LTS-SP4 版本的测试阶段，主要涵盖了功能测试、安全性测试和可靠性测试。通过3*24小时的长时间稳定性测试，顺利完成了 16 个子模块的测试，执行了总计 138 个测试用例。整体核心功能表现稳定，插件功能运行正常。
...
| ------------------------------ | ---------- | -------------- | ---------- |
| openEuler RISC-V 24.03-LTS-SP4 | 138        | 通过138个失败0个 | 0个        |
