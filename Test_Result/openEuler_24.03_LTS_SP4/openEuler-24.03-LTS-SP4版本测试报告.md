...
| 40  | 支持KubeSphere                                     |               NA               |                      |                      |  NA                 |     |     |
| 41  | 支持OpenStack Train 和 Wallaby                      |               NA               |                      |                      |   <font color=green>█</font>      |     |     |
...
| 52  | LLVM平行宇宙计划 RISC-V Preview 版本                     |               NA               |                      |                      |   NA                |     |     |
| 53  | virtCCA机密虚机特性合入                                  | <font color=green> █  </font>  |                      |                      |   NA                |     |     |
| 54  | 增加YouQu自动化测试平台支持                                 |               NA               |                      |                      |  NA                 |     |     |
...
| 66  | Add OpenVINO packages native support             |               NA               |                      |                      |   NA                |     |     |
| 67  | Add oneAPI low level native support              |               NA               |                      |                      |   NA                |     |     |
...
| 92  | URMA：URMA支持UB基础通信能力                              |    <font color=red>●</font>    |                      |                      |   NA                |     |     |
...
| 96  | UBTurbo: HAM支持确定性热迁移能力                           |               NA               |                      |                      |     NA              |     |     |
| 97  | UBTurbo： SMAP支持内存冷热扫描和迁移能力                       | <font color=green> █  </font>  |                      |                      |   NA                |     |     |
| 98  | UBTurbo：RMRS Agent支持内存迁移决策与执行                    |               NA               |                      |                      |    NA               |     |     |
| 99  | UB Turbo： UBTurbo提供基础框架(配置读取、插件加载、日志管理、IPC通信等)能力 |               NA               |                      |                      |    NA               |     |     |
...
| openEuler 24.03 LTS SP4 loongarch64   | 33   |  28     | 5      |    5   |     |
