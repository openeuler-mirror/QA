...
| 日期         | 修订   版本 | 修改描述           | 作者         |
| ---------- | ------- | -------------- | ---------- |
| 2025/06/30 | v 1.0.0 | 新增ACPO继承特性测试结果 | xiongyikun |
...
| 版本名称            | 测试起始时间     | 测试结束时间     |
| --------------- | ---------- | ---------- |
| openEuler 24.03 LTS SP2 | 2025/06/11 | 2025/06/30 |
...
| 测试子项    | 测试结论                          | 备注                        |
| ------- |:-----------------------------:| ------------------------- |
| 自训练模型推理 | <font color=green>PASS</font> | 推理结果正确, 使能ACPO后性能提升8.5% |
...
| --------------- | ----- | ------- | ------ |
| openEuler 24.03 LTS SP2 | 5     | 100% 通过 | 0      |
