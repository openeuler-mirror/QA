...
摘要：
本报告主要描述基于openEuler 24.03-LTS版本进行的支持嵌入式极简镜像（iSulad）特性的测试过程，报告对测试情况进行说明，对特性的测试充分度进行评估和总结。
...
| 版本名称 | 测试起始时间 | 测试结束时间 |
| -------- | ------------ | ------------ |
|openEuler-24.03-LTS| 2024-05-14 | 2024-05-15 |
...
支持嵌入式极简镜像特性，共计执行1个用例，主要覆盖了功能测试，整体质量良好。
