...
openEuler embedded 22.03版本整体测试按照release-manager团队的计划，共完成了一轮基础功能测试+一轮新特性专项测试+一轮回归测试；
...
​openEuler embedded 22.03版本共发现问题63个，有效问题51个，遗留问题2个(详见遗留问题章节)，其他问题均已修复，回归测试结果正常。版本整体质量较好。
...
1、Linux系统安全配置管理类主要包括：服务管理、账号密码管理、文件及用户权限管理、内核参数配置管理、日志管理等进行全量测试，发现5个相关问题，1个问题遗留。
...
openEuler 22.03 embedded版本共发现问题单63个，有效问题51个，其中修复问题单49个，回归均通过。详细分布见下表:

| 测试阶段                    | 问题单数 |
| --------------------------- | -------- |
| openEuler embedded RC1 | 9   |
| openEuler embedded RC2 | 32  |
| openEuler embedded RC3 | 22  |
