...
摘要：依据测试要求，对gcc-7进行自编译、安装卸载验证及功能测试。
...
gcc-7特性，测试使用deja测试套，共执行98213个测试用例，代码覆盖率90%。覆盖特性的基本功能，自编译以及安装卸载，不涉及命令验证和服务验证。未发现问题，所有测试点全部通过
...
|-----------------------------|-------------|--------|-------------------|--------|----|
| gcc-7                      | 2144         | 95399   |  188               |   482   |98213| 
