...
# 3 版本概要测试结论
   ...
   openEuler 20.03 LTS SP4 版本截止到RC3共发现问题 239 个，有效问题 227 个，无效问题 12 个。遗留问题 0 个，版本整体质量良好。
...
| --------------------------- | -------- | ------------ | ------------ | ------------ | -------------------------- |
| openEuler 20.03 LTS SP4 dailybuild |    95    |     92     |       3       |     0      |                   |
| openEuler 20.03 LTS SP4 alpha |    39    |     36      |       3       |     0      |                   |
