...
​openEuler embedded 22.09版本目前共发现问题92个，修复问题85个，拒绝问题单2个，取消问题单5个，版本整体质量较好，风险可控。
...
| 2 | 基于分布式软总线扩展生态互联互通 |测试软总线IPC多对一功能需求，测试IPC的生命周期，测试device auth模块迁移，测试支持从系统获取UDID |  | 0  | <font color=green>█</font> |  |
...
2、通过工具进行CVE漏洞/敏感信息/端口矩阵/编译选项扫描/交付件病毒扫描，其中发现新增CVE漏洞18个，已提交社区issue，开放22和68端口用于ssh和通过dhcp获取ip地址，编译选项扫描正常，问题均修复或为误报已确认，敏感信息扫描已确认无敏感信息，交付件无病毒。
...
| 硬实时系统性能 | 适配后的RhealStone用例测试 | 首次形成基线 | 上下文切换时延2us，中断时延1us |
