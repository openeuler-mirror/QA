...
| 5    | I4BOBA | [诊断报告列表的表名不准确](https://gitee.com/src-openeuler/A-Ops/issues/I4BOBA?from=project-issue) | 中 | 展示的表名不准备，不影响功能的使用 | 待办 |
| 6    | I4BO4X | [页面的提示语不正确，且有的提示语有的是中文有的是英文](https://gitee.com/src-openeuler/A-Ops/issues/I4BO4X?from=project-issue) | 中 | 提示语不统一，不影响功能的使用 | 待办 |
