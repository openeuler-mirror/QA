...
| 日期 | 修订   版本 | 修改描述 | 作者 |
| ---- | ----------- | -------- | ---- |
| 2025-12-2  |  1.0 | 创建  | jinchenyu  |

关键词： 
etipc(enhanced tipc)

摘要：
本报告主要描述基于openEuler 24.03 LTS SP1版本进行的etipc软件包的基础测试，报告对测试情况进行说明，对特性的测试充分度进行评估和总结。
...
| Msg Size | Conns | Msgs  |  Elapsed | Total [Msg/s] | Total [Mb/s] | Per Conn [Mb/s] |
| -------- | ------ | ----------- | --------- | -------------- | ------------ | ------------- |
